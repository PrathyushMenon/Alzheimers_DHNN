...
def main():
    ...
    # add timestamp to logdir, preserving absolute local output dirs supplied by
    # the reproduction wrapper.
    if os.path.isabs(args.logdir):
        args.logdir = args.logdir + "_random_" + f"_{args.modality}_originstructure_" + time.strftime("%Y%m%d-%H%M%S")
    else:
